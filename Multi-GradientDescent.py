...
# matplotlib 初始化
ls = [0]
loss_draw = [sess.run(loss, {x: sample, y_label: label})]
loss_temp = 0
t_0_draw = [0]
t_1_draw = [0]
t_2_draw = [0]
...
# 测试
print(sess.run(h, {x: np.array([[1, 14.96, 41.76, 1024.07, 73.17], [1, 33.58, 77.54, 1010.19, 53.49]]).T}))
